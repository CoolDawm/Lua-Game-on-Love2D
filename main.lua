...
M=require 'libraries/Moses-master/moses'
...
draft = Draft()
ripple = require 'libraries/ripple-master/ripple' -- if it's in subfolders
...
function love.load()
    ...
    input:bind('b', function() gotoRoom('Menu') end)
