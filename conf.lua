...
function love.conf(t)
    ...
    t.version = "11.4"                -- Версия LOVE, для которой сделана эта игра (строка)
    t.console = true                  -- Подключение консоли (boolean, только в Windows)
 
    t.window.title = "DIABOLICAL" -- Заголовок окна (строка)
